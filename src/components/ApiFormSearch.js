...
const ApiFormSearch = ({handleSubmit,title,description,https,yesHttps}) => {
    ...
    return (
        ...
        <label htmlFor="title">Title</label><input id="title" type="text" name="title" value={title}  onChange={formik.handleChange}
        value={formik.values.title}/>
        <label htmlFor="description">Description</label><input id="description" type="text" name="description" value={description}  onChange={formik.handleChange}
